...
for vcn in vcns:
    ...
    # 2. Update route tables to remove IGW references, then delete them
    ...
    for rt in rts:
        ...
        try:
            ...
            rt_details = network_client.get_route_table(rt.id).data
            
            # Remove all route rules
            rt_details.route_rules = []
            
            # Update route table with no routes
