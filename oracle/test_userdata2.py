#!/usr/bin/env python3
"""Test with actual user-data-simple.sh content"""
...
vcn = network_client.create_vcn(
    create_vcn_details=oci.core.models.CreateVcnDetails(
        compartment_id=compartment_id, display_name="ud2-test-vcn", cidr_block="10.0.0.0/16"
    )
).data
...
igw = network_client.create_internet_gateway(
    create_internet_gateway_details=oci.core.models.CreateInternetGatewayDetails(
        compartment_id=compartment_id, display_name="ud2-test-igw", vcn_id=vcn.id, is_enabled=True
    )
).data

rt = network_client.create_route_table(
    create_route_table_details=oci.core.models.CreateRouteTableDetails(
        compartment_id=compartment_id, display_name="ud2-test-rt", vcn_id=vcn.id,
...
sl = network_client.create_security_list(
    create_security_list_details=oci.core.models.CreateSecurityListDetails(
        compartment_id=compartment_id, display_name="ud2-test-sl", vcn_id=vcn.id,
...
subnet = network_client.create_subnet(
    create_subnet_details=oci.core.models.CreateSubnetDetails(
        compartment_id=compartment_id, display_name="ud2-test-subnet", vcn_id=vcn.id,
...
with open(r'C:\ai_survival\oracle\user-data-simple.sh', 'rb') as f:
    user_data = base64.b64encode(f.read()).decode()

print("Creating test instance with user-data-simple.sh...")
instance = compute_client.launch_instance(
    launch_instance_details=oci.core.models.LaunchInstanceDetails(
        compartment_id=compartment_id, display_name="ud2-test",
